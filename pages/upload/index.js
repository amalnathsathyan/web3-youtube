...
import { useCreateAsset, createAsset } from '@livepeer/react';
...
export default function Upload() {
  ...
  const { mutate: createAsset, data: asset, uploadProgress, status, error } = useCreateAsset();
  ...
  // Function to save the video to the Contracts
